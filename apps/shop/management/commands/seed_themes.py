...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("source_dir", type=str, help="Path to directory containing theme JPEG files.")
        parser.add_argument("--clear", action="store_true", help="Delete all existing wallpaper products first.")
    ...
    def handle(self, *args, **options):
        ...
        if options["clear"]:
            ...
            self.stdout.write(self.style.WARNING(f"Cleared {deleted} existing wallpaper products."))
