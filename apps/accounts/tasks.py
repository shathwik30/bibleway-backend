...
@shared_task(
    bind=True, max_retries=3, default_retry_delay=30, soft_time_limit=30, time_limit=60
)
...
@shared_task(
    bind=True, max_retries=1, default_retry_delay=60, soft_time_limit=60, time_limit=120
)
